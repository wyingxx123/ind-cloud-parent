package com.dfc.ind.common.datascope.aspect;
...
import com.dfc.ind.common.datascope.service.AwaitUserService;
...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.dfc.ind.common.datascope.annotation.DataScope)")
