...
public class SysPostServiceImpl extends ServiceImpl<SysPostMapper, SysPost> implements ISysPostService
{
     ...
     */
    @Override
    public String selectPostsByUserId(Long userId) {
        List<SysPost> sysPostList = baseMapper.selectPostsByUserId(userId);
        StringBuffer sb = new StringBuffer();
        for (SysPost sysPostEntity : sysPostList) {
            sb.append(sysPostEntity.getPostName()).append(",");
        }
