...
import com.dfc.ind.common.security.service.RedisClientDetailsService;
...
import com.dfc.ind.auth.exception.CustomWebResponseExceptionTranslator;
    ...
    public TokenEnhancer tokenEnhancer()
    {
        return (accessToken, authentication) -> {
            if (authentication.getUserAuthentication() != null)
            {
                ...
                additionalInformation.put(SecurityConstants.DETAILS_M_ID, user.getMerchantId());
