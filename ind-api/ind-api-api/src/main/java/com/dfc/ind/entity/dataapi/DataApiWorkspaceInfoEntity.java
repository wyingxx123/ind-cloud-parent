...
@TableName("data_api_workspace_info")
@ApiModel(value="DataApiWorkspaceInfoEntity对象", description="工作空间资源信息")
public class DataApiWorkspaceInfoEntity implements Serializable {
