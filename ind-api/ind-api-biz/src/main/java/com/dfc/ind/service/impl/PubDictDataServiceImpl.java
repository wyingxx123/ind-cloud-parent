 ...
 */
@Service
public class PubDictDataServiceImpl extends MppServiceImpl<PubDictDataMapper, PubDictDataEntity> implements IPubDictDataService {
    ...
    public void addDictData(PubDictDataEntity pubDictDataEntity) {
        ...
        this.saveOrUpdateByMultiId(pubDictDataEntity);
    }
